...
from main.views import create_project, create_testimonial, delete_project, delete_testimonial, edit_testimonial, get_projects_json, get_testimonials_json, show_main, show_experience, show_education, show_projects, show_testimonials
